...
public class TempFarBlue extends OpMode{
    ...
    private final Pose PreScore = new Pose(60, 22, Math.toRadians(115)); // PRE-LOAD SCORING POSITION
    private final Pose Grab1Set = new Pose(45, 35.7, Math.toRadians(0)); // POSITION
    private final Pose Grab1 = new Pose(24, 35.7, Math.toRadians(0)); // POSITION
    private final Pose Score1 = new Pose(60, 75, Math.toRadians(139)); // POSITION
    private final Pose Score1CP = new Pose(60, 35.7, Math.toRadians(139)); // CONTROL POINT
    private final Pose Grab2Set = new Pose(45, 60, Math.toRadians(0)); // POSITION
    private final Pose Grab2 = new Pose(24, 60, Math.toRadians(0)); // POSITION
    ...
    private final Pose Grab3 = new Pose(24, 84, Math.toRadians(0)); // POSITION
    private final Pose Score3 = new Pose(60, 75, Math.toRadians(139)); // POSITION
